    ...
    var Shuffle = function (_TinyEmitter) {
        ...
        createClass(Shuffle, [{
            ...
            value: function _doesPassFilter(category, element) {
                ...
                // Negar Change for IE 11 support
                function testCategoryIE(category) {
                ...
                }else if(msieversion() === 0){
                    // If using IE
                    if (Array.isArray(category)) {
                        if (this.options.filterMode === Shuffle.FilterMode.ANY) {
                            return category.some(testCategoryIE);
                        }
                        return category.every(testCategoryIE);
                    }
                    return (keys.indexOf(category) > -1 );
                }
                // END! Negar Change for IE 11 support
...
// Negar Added function to check if browser is IE
...
// End! Negar Added function to check if browser is IE